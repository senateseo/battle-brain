...
$('[data-plugin="switchery"]').each(function(index, element) {
            ...
            changeIsPremiumSwitch.onchange = function() {
                if (changeIsPremiumSwitch.checked){
                    ...
                    $('#is_premium').val(0);
                    $('.is_premium_coins_div').hide().find('.is_premium_coin').removeAttr('required');
                }
            };
            ...
            changeEditIsPremiumSwitch.onchange = function() {
                if (changeEditIsPremiumSwitch.checked){
                    ...
                    $('.edit_is_premium_coins_div').show(300).find('.edit_coins').attr('required',true);
                }
                else{
                    $('#edit_is_premium').val(0);
                    $('.edit_is_premium_coins_div').hide().find('.edit_coins').removeAttr('required');
                }
            };
