...
class SystemConfigCubit extends Cubit<SystemConfigState> {
  ...
  bool isDailyAdsEnabled() => state is SystemConfigFetchSuccess
      ? (state as SystemConfigFetchSuccess).systemConfigModel.isDailyAdsEnabled
      : false;

  String coinsPerDailyAdView() => state is SystemConfigFetchSuccess
      ? (state as SystemConfigFetchSuccess)
          .systemConfigModel
          .coinsPerDailyAdView
          .toString()
