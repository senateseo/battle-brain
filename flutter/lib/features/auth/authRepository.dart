...
class AuthRepository {
  ...
  String getAuthTypeString(AuthProviders provider) {
    String authType;
    if (provider == AuthProviders.fb) {
      authType = "fb";
    } else if (provider == AuthProviders.gmail) {
      authType = "gmail";
    } else if (provider == AuthProviders.mobile) {
      authType = "mobile";
